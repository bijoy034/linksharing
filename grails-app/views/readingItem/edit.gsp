...
<html>
	...
	<body>
		<a href="#edit-readingItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-readingItem" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:readingItemInstance, action:'update']" method="PUT" >
